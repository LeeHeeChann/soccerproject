    ...
    <div class="text"></div>
      ...
      <div class="album py-5 bg-light">
        <div class="container" >
          ...
          <div class="row">
            <div class="col-md-4" >
              <div class="card mb-4 box-shadow" style="height: 95%; width: 90%; border:1px solid black;">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow" style="height: 95%;">
              	<a align="middle"> <iframe width="100%" height="150%" src="https://tv.naver.com/embed/22055257?autoPlay=false" frameborder="0" allow="accelerometer; picture-in-picture" allowfullscreen></iframe></a>
                <div class="card-body">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow" style="height: 95%;">
              	<a align="middle"><iframe width="100%" height="150%" src="https://www.youtube.com/embed/yTjQ0ORtk5U" frameborder="0" allow="accelerometer; picture-in-picture" allowfullscreen></iframe></a>
                <div class="card-body">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow" style="height: 95%;">
              	<a align="middle"><iframe width="100%" height="150%" src="https://www.youtube.com/embed/4dKT3UERbZY" frameborder="0" allow="accelerometer; picture-in-picture" allowfullscreen></iframe></a>
                <div class="card-body">
